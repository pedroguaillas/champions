<div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
            <x-adminlte-small-box title="{{ $games }}" text="Partidos creados" icon="fas fa-star text-white" theme="warning" url="{{ url('seleccionar_categoria') }}" url-text="Ver todos los partidos" />
        </div>
        <div class="col-md-6 col-lg-3">
